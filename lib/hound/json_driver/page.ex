defmodule Hound.JsonDriver.Page do
  ...
  def find_element(strategy, selector) do
    ...
    make_req(:post, "session/#{session_id}/element", params)
  end
  ...
  def find_all_elements(strategy, selector) do
    session_id = Hound.get_current_session_id
    params = [using: Hound.InternalHelper.selector_strategy(strategy), value: selector]
    make_req(:post, "session/#{session_id}/elements", params)
  end
  ...
  def find_within_element(element_id, strategy, selector) do
    session_id = Hound.get_current_session_id
    params = [using: Hound.InternalHelper.selector_strategy(strategy), value: selector]
    make_req(:post, "session/#{session_id}/element/#{element_id}/element", params)
  end
  ...
  def find_all_within_element(element_id, strategy, selector) do
    session_id = Hound.get_current_session_id
    params = [using: Hound.InternalHelper.selector_strategy(strategy), value: selector]
    make_req(:post, "session/#{session_id}/element/#{element_id}/elements", params)
  end
